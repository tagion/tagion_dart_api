...
int32_t tagion_sign_message(const SecureNet *const root_net, const uint8_t *const message_ptr, const uint64_t message_len, uint8_t **signature_ptr, uint64_t *signature_len);