...
int32_t tagion_hibon_add_bigint(const HiBONT* const instance, const char* const key, const uint64_t key_len, const uint8_t* const bigint_buf, const uint64_t bigint_buf_len);

int32_t tagion_hibon_add_bool(const HiBONT* const h, const char* const key, const uint64_t key_len, bool value);

int32_t tagion_hibon_add_array_bool(const HiBONT* const h, const char* const key, const uint64_t key_len, uint8_t* buf, const uint64_t buf_len);

int32_t tagion_hibon_add_int32(const HiBONT* const h, const char* const key, const uint64_t key_len, int32_t value);

int32_t tagion_hibon_add_array_int32(const HiBONT* const h, const char* const key, const uint64_t key_len, uint8_t* buf, const uint64_t buf_len);

int32_t tagion_hibon_add_int64(const HiBONT* const h, const char* const key, const uint64_t key_len, int64_t value);

int32_t tagion_hibon_add_array_int64(const HiBONT* const h, const char* const key, const uint64_t key_len, uint8_t* buf, const uint64_t buf_len);

int32_t tagion_hibon_add_uint32(const HiBONT* const h, const char* const key, const uint64_t key_len, uint32_t value);

int32_t tagion_hibon_add_array_uint32(const HiBONT* const h, const char* const key, const uint64_t key_len, uint8_t* buf, const uint64_t buf_len);

int32_t tagion_hibon_add_uint64(const HiBONT* const h, const char* const key, const uint64_t key_len, uint64_t value);

int32_t tagion_hibon_add_array_uint64(const HiBONT* const h, const char* const key, const uint64_t key_len, uint8_t* buf, const uint64_t buf_len);

int32_t tagion_hibon_add_float32(const HiBONT* const h, const char* const key, const uint64_t key_len, float value);

int32_t tagion_hibon_add_array_float32(const HiBONT* const h, const char* const key, const uint64_t key_len, uint8_t* buf, const uint64_t buf_len);
