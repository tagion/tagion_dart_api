...
int32_t tagion_document(const uint8_t *const buf, const uint64_t buf_len, const char *const key, const uint64_t key_len, Element *element);
...
int32_t tagion_document_array(const uint8_t *const buf, const uint64_t buf_len, const uint64_t index, Element *element);
